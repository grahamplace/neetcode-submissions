...
class AutocompleteSystem:
    ...
    def _insert_sentence_trie(self, sentence: str, times: int) -> None:
        ...
        curr.sentence_end_count += times


    # def _return_sentences_below_node(self, prefix: str, node: TrieNode) -> set[str]:
    #     results = set()
    #     if node.sentence_end_count > 0:
    #         results.add(prefix)
        
    #     for k, child in node.children.items():
    #         results = results.union(self._return_sentences_below_node(prefix + k, child))
    ...
    def _search_prefix(self, prefix: str) -> set[str]:
        ...
        # return self._return_sentences_below_node(prefix, curr)
    ...
    def input(self, c: str) -> List[str]:
        if c == '#':
            ...
            self._insert_sentence_trie(self.current_query, 1)
            self.current_query = ""
            return []
